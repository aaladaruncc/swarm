    ...
    <section className="relative py-12 sm:py-16 md:py-20 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-8 max-w-4xl relative z-10">
        ...
        >
          ...
          <div className="relative bg-white/95 backdrop-blur-sm rounded-2xl border border-white/20 shadow-2xl p-6 sm:p-8 md:p-10 overflow-hidden">
            {/* Aurora effect */}
            ...
            <div className="relative z-10">
              <h2 className="text-xl sm:text-2xl md:text-3xl font-light text-slate-900 mb-2 sm:mb-3 leading-tight">
                Ready to unlock the future?
              </h2>
              <p className="text-sm sm:text-base md:text-lg text-slate-600 font-light leading-relaxed mb-5 sm:mb-6 max-w-2xl mx-auto">
                Stop shipping blind. Validate your product decisions with real user behavior before launch.
              </p>
              <a
                href="#"
                className="inline-flex items-center gap-2 px-6 sm:px-8 py-3 sm:py-3.5 bg-slate-900 text-white text-sm font-medium rounded-lg hover:bg-slate-800 transition-colors shadow-lg"
              >
