...
export default function Dashboard() {
  ...
  const loadScreenshotTests = async () => {
    try {
      const data = await getScreenshotTests();
      setScreenshotTests(data.tests);
    } catch (err) {
      console.error("Failed to load screenshot tests:", err);
    } finally {
    ...
    <div className="p-8 max-w-7xl mx-auto w-full">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 mb-8">
        ...
        <div className="flex items-center gap-3">
          <Link
            ...
            className={`group flex items-center justify-center gap-2 border px-5 py-2.5 transition-all text-sm font-medium shadow-lg hover:shadow-xl hover:-translate-y-0.5 duration-300 rounded-lg ${isLight
      ...
      <div className={`border flex flex-col relative overflow-hidden shadow-sm rounded-xl ${isLight
        ...
        <div className={`flex items-center justify-between px-6 py-4 border-b backdrop-blur-sm z-20 ${isLight
          ...
          <div className="flex items-center gap-3">
            <div className={`flex items-center rounded-full border p-1 ${isLight
          ...
          <div className={`border p-6 max-w-sm w-full shadow-2xl animate-in fade-in zoom-in-95 duration-200 rounded-xl ${isLight
            ...
            <div className="flex justify-end gap-3">
              <button
                ...
                className={`px-4 py-2 text-sm font-medium transition-colors rounded-lg ${isLight
