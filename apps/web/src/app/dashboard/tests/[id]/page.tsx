    ...
    <div className={`p-8 max-w-7xl mx-auto w-full min-h-screen ${
      ...
      {loading ? (
        ...
        <div className="space-y-8">
          ...
          <div className={`border rounded-lg overflow-hidden transition-all ${
              ...
              <div className="flex items-start justify-between gap-4 mb-3">
                <div className="flex-1 min-w-0">
                  ...
                  <a
                    ...
                    className={`text-sm font-light flex items-center gap-2 group mb-2 ${
                      isLight
                ...
                <button
                  ...
                  className={`p-1.5 transition-colors rounded shrink-0 ${
                    isLight
            ...
            {isMetadataExpanded && (
              <div className={`border-t p-4 space-y-4 transition-all duration-200 ${
                        ...
                        return (
                          ...
                          >
                            {isCompleted ? (
                              ...
                              <div className={`w-2.5 h-2.5 border shrink-0 ${
                                isLight ? "border-neutral-400" : "border-neutral-500"
                              }`} />
                            )}
          ...
          {/* Running State */}
          {["running_tests", "aggregating", "running_uxagent"].includes(batchTestRun.status) && (
            <div className={`border p-8 flex items-center gap-6 rounded-xl ${
              isLight
                ? "bg-white border-neutral-200"
                : "border-white/10 bg-[#1E1E1E]"
            }`}>
              <Loader2 className={`w-10 h-10 animate-spin shrink-0 ${
                isLight ? "text-neutral-500" : "text-neutral-400"
              }`} />
                ...
                <div className="space-y-8">
                  ...
                  <div className={`border p-8 rounded-xl ${
                    ...
                    <div className="flex items-center gap-8">
                      <div className={`text-6xl font-light ${
                        ...
                        {aggregatedReport.overallScore}<span className={`text-3xl ${
                          isLight ? "text-neutral-500" : "text-neutral-400"
                        }`}>/10</span>
                      </div>
                      <div className="flex-1">
                    ...
                    {aggregatedReport.executiveSummary && (
                      <p className={`mt-6 font-light leading-relaxed whitespace-pre-wrap ${
                        isLight ? "text-neutral-700" : "text-neutral-300"
                      }`}>
                        {aggregatedReport.executiveSummary}
                      </p>
                        ...
                        {aggregatedReport.commonIssues.map((issue, i) => (
                          <div key={i} className={`border-l-4 p-4 rounded-lg ${getSeverityColor(issue.severity)}`}>
                            <div className="flex items-start justify-between mb-2">
                              ...
                              <span className={`text-xs px-2 py-1 border uppercase font-medium rounded-lg ${
                                isLight
                            ...
                            <div className="flex flex-wrap gap-1">
                              {issue.affectedPersonas.map((persona, j) => (
                                <span key={j} className={`text-xs px-2 py-0.5 border font-light rounded-lg ${
                                  isLight
                                    ? "bg-neutral-100 border-neutral-300 text-neutral-700"
                                    : "bg-[#252525] border-white/10 text-neutral-300"
                                }`}>
                    ...
                    <div className={`border p-8 rounded-xl ${
                      ...
                      <div className="space-y-4">
                        {aggregatedReport.recommendations.map((rec, i) => (
                          <div key={i} className={`border-l-4 pl-6 py-2 ${
                            isLight ? "border-l-neutral-300" : "border-l-white/20"
                          }`}>
                  ...
                  {aggregatedReport.fullAnalysis && (
                    <div className={`border p-8 rounded-xl ${
                      ...
                      <div className={`max-w-none font-light leading-relaxed ${
                        isLight ? "text-neutral-700" : "text-neutral-300"
                      }`}>
                        <ReactMarkdown
                          components={{
                            h3: ({ children }) => <h3 className={`text-lg font-medium mt-6 mb-3 ${
                              isLight ? "text-neutral-900" : "text-white"
                            }`}>{children}</h3>,
                            p: ({ children }) => <p className={`mb-4 ${
                              isLight ? "text-neutral-700" : "text-neutral-300"
                            }`}>{children}</p>,
                            ...
                            li: ({ children }) => <li className={`ml-4 ${
                              isLight ? "text-neutral-700" : "text-neutral-300"
                            }`}>{children}</li>,
                            strong: ({ children }) => <strong className={`font-medium ${
                              isLight ? "text-neutral-900" : "text-white"
                            }`}>{children}</strong>,
                  ...
                  <div className={`border p-8 rounded-xl ${
                    ...
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <button
                        ...
                        className={`flex items-center gap-2 px-4 py-2 border transition-colors text-sm font-medium rounded-lg ${
                          isLight
                    ...
                    {testRuns[selectedView].testRun.personaData && (
                      <div className="grid md:grid-cols-3 gap-6 text-sm">
                        <div>
                          ...
                          <p className={`font-light ${
                            isLight ? "text-neutral-200" : "text-neutral-300"
                  ...
                  <div className={`border p-8 rounded-xl ${
                    ...
                    <div className="flex items-center gap-6">
                      <div className={`text-5xl font-light ${
                        ...
                        {testRuns[selectedView].report?.score}<span className={`text-2xl ${
                          isLight ? "text-neutral-500" : "text-neutral-400"
                        }`}>/10</span>
                      </div>
                      <div className="flex-1">
                              ...
                              {swarmAgentActiveTab === "logs" && (
                                <div className={`border p-6 rounded-xl ${
                                  ...
                                  {selectedRun.logContent ? (
                                    <div className={`p-4 max-h-[500px] overflow-y-auto rounded-lg border ${
                                      isLight
                                        ? "bg-neutral-50 border-neutral-200"
                                        : "bg-[#252525] border-white/5"
                                    }`}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className={`text-sm font-light flex items-center gap-2 group ${
                            isLight
                              ? "text-neutral-600 hover:text-neutral-900"
                              : "text-neutral-300 hover:text-white"
                          }`}
                              ...
                              <div className="flex items-start justify-between mb-3">
                                <div>
                                  <h3 className={`font-medium mb-1 ${
                                    ...
                                    {!isSelected && <span className={`text-xs ml-2 ${
                                      isLight ? "text-neutral-500" : "text-neutral-500"
                                    }`}>(Not Selected)</span>}
                                  </h3>
                    ...
                    <div className={`border p-6 rounded-xl ${
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                        <div className={`p-4 border rounded-lg ${
                          ...
                          <p className={`text-xs uppercase tracking-wide font-light mb-1 ${
                            isLight ? "text-neutral-500" : "text-neutral-400"
                          }`}>Total</p>
          ...
          <div className={`border p-6 max-w-sm w-full shadow-2xl animate-in fade-in zoom-in-95 duration-200 rounded-xl ${
            ...
            <div className="flex justify-end gap-3">
              ...
              <button
                ...
                disabled={isTerminating}
                className={`px-4 py-2 text-sm border transition-colors shadow-sm rounded-lg disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 ${
                  isLight
      ...
      {selectedPersonaDetail && (
        <div className={`fixed inset-0 backdrop-blur-sm z-[60] flex items-center justify-center p-4 ${
          ...
          <div className={`border p-8 max-w-3xl w-full max-h-[90vh] overflow-y-auto shadow-2xl animate-in fade-in zoom-in-95 duration-200 rounded-xl ${
            isLight
              ? "bg-white border-neutral-200"
              : "bg-[#1E1E1E] border-white/10"
          }`}>
            ...
            <div className="space-y-6">
              ...
              <div className={`border p-6 rounded-lg ${
                ...
                {selectedPersonaDetail.persona.primaryGoal && (
                  <div className="mb-4">
                    <p className={`text-xs uppercase tracking-wide mb-2 font-light ${
                      isLight ? "text-neutral-500" : "text-neutral-400"
                    }`}>Primary Goal</p>
                    <p className={`text-sm font-light ${
                      isLight ? "text-neutral-900" : "text-white"
