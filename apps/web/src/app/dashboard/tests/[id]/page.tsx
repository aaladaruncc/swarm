...
export default function TestDetails() {
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto w-full bg-neutral-950 min-h-screen">
      {/* Breadcrumb Header */}
      <div className="mb-8 flex-shrink-0">
        ...
        <div className="flex items-center justify-between">
          <h1 className="text-3xl font-light tracking-tight text-white mb-2">Test Results</h1>
          {batchTestRun?.status === "completed" && aggregatedReport && (
            <button
              ...
              className="flex items-center gap-2 bg-[#252525] text-white border border-white/10 px-4 py-2 hover:bg-[#333] transition-all text-sm font-medium shadow-sm rounded-lg disabled:opacity-50"
            >
              {exportingPDF ? (
                <>
      ...
      {error && (
        <div className="bg-red-500/10 text-red-400 px-4 py-3 text-sm border border-red-500/20 mb-8 font-light rounded-lg">
          {error}
        </div>
      )}
      ...
      {loading ? (
        ...
        <div className="space-y-8">
          ...
          <div className="border border-white/10 bg-[#1E1E1E] rounded-lg overflow-hidden transition-all">
              ...
              <div className="flex items-start justify-between gap-4 mb-3">
                <div className="flex-1 min-w-0">
                  ...
                  <a
                    ...
                    className="text-sm font-light text-neutral-300 hover:text-white flex items-center gap-2 group mb-2"
                  >
                  ...
                  {["running_tests", "aggregating", "running_uxagent"].includes(batchTestRun.status) && (
                    <div className="text-xs text-neutral-400 font-light mb-1">
                ...
                <button
                  ...
                  className="p-1.5 hover:bg-white/10 transition-colors rounded text-neutral-400 hover:text-white shrink-0"
            ...
            {isMetadataExpanded && (
              <div className="border-t border-white/10 p-4 space-y-4 transition-all duration-200">
                {/* Target Audience */}
                <div>
                  <p className="text-xs font-medium text-neutral-400 uppercase tracking-wide mb-1.5">Target Audience</p>
                  <p className="text-sm text-neutral-300 font-light">{batchTestRun.userDescription}</p>
                </div>
                
                {/* Persona Status Grid */}
                {testRuns.length > 0 && (
                  <div>
                    <p className="text-xs font-medium text-neutral-400 uppercase tracking-wide mb-2">Agent Status</p>
                        ...
                        return (
                          ...
                          >
                            {isCompleted ? (
                              ...
                              <div className="w-2.5 h-2.5 border border-neutral-500 shrink-0" />
                            )}
                            <span className={`font-medium truncate ${isCompleted ? "text-emerald-400" :
                              isRunning ? "text-blue-400" :
                                isFailed ? "text-red-400" :
                                  isTerminated ? "text-orange-400" :
                                    "text-neutral-400"
                              }`}>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2 border-t border-white/5">
                  <div>
                    <p className="text-xs font-medium text-neutral-400 uppercase tracking-wide mb-1">Test Configuration</p>
                  ...
                  <div>
                    <p className="text-xs font-medium text-neutral-400 uppercase tracking-wide mb-1">Timestamps</p>
                    <div className="space-y-1 text-xs text-neutral-300 font-light">
                ...
                {batchTestRun.errorMessage && (
                  <div className="border-l-4 border-red-500 bg-red-500/10 p-3 rounded">
                    ...
                    <p className="text-sm text-red-300 font-light">{batchTestRun.errorMessage}</p>
                  </div>
                )}
              </div>
            )}
          ...
          {/* Running State */}
          {["running_tests", "aggregating", "running_uxagent"].includes(batchTestRun.status) && (
            <div className="border border-white/10 bg-[#1E1E1E] p-8 flex items-center gap-6 rounded-xl">
          ...
          {batchTestRun.status === "failed" && (
            <div className="border border-red-500/20 bg-red-500/10 p-6 rounded-xl">
              <h3 className="text-lg font-medium text-red-400 mb-2">Batch Test Failed</h3>
          ...
          {batchTestRun.status === "terminated" && (
            <div className="border border-orange-500/20 bg-orange-500/10 p-6 rounded-xl">
              <h3 className="text-lg font-medium text-orange-400 mb-2">Batch Test Terminated</h3>
            ...
            <>
              ...
              {activeMainTab === "results" && (
                <>
                  ...
                  {!batchTestRun.useUXAgent && typeof selectedView === "number" && testRuns.length > 1 && (
                    <div className="bg-[#1E1E1E] border border-white/10 p-4 rounded-xl mb-6">
                              ...
                              <div className="flex items-start justify-between mb-2">
                                <div className="flex items-center gap-2">
                                  <div className={`w-8 h-8 rounded-full flex items-center justify-center ${isSelected ? "bg-white/10" : "bg-white/5"
                                    ...
                                    <Users size={16} className={isSelected ? "text-white" : "text-neutral-400"} />
                                  </div>
                                  <div>
                ...
                <div className="space-y-8">
                  {/* Overall Score */}
                  <div className="border border-white/10 bg-[#1E1E1E] p-8 rounded-xl">
                    <h2 className="text-xl font-medium mb-6 text-white">Overall UX Score</h2>
                    ...
                    {aggregatedReport.executiveSummary && (
                      <p className="mt-6 text-neutral-300 font-light leading-relaxed whitespace-pre-wrap">
                        {aggregatedReport.executiveSummary}
                      </p>
                    )}
                  </div>
                  ...
                  {aggregatedReport.commonIssues && aggregatedReport.commonIssues.length > 0 && (
                    <div className="border border-white/10 bg-[#1E1E1E] p-8 rounded-xl">
                      <h2 className="text-xl font-medium mb-6 text-white">Common Issues</h2>
                        ...
                        {aggregatedReport.commonIssues.map((issue, i) => (
                          <div key={i} className={`border-l-4 p-4 rounded-lg ${getSeverityColor(issue.severity)}`}>
                            <div className="flex items-start justify-between mb-2">
                              ...
                              <span className="text-xs px-2 py-1 bg-[#252525] border border-white/10 uppercase font-medium text-neutral-300 rounded-lg">
                                {issue.severity}
                              </span>
                            </div>
                            ...
                            <div className="flex flex-wrap gap-1">
                              {issue.affectedPersonas.map((persona, j) => (
                                <span key={j} className="text-xs px-2 py-0.5 bg-[#252525] border border-white/10 font-light text-neutral-300 rounded-lg">
                                  {persona}
                                </span>
                              ))}
                            </div>
                  ...
                  {aggregatedReport.strengthsAcrossPersonas && aggregatedReport.strengthsAcrossPersonas.length > 0 && (
                    <div className="border border-white/10 bg-[#1E1E1E] p-8 rounded-xl">
                      <h2 className="text-xl font-medium mb-6 text-emerald-400">What Works Well</h2>
                      <ul className="space-y-2">
                        {aggregatedReport.strengthsAcrossPersonas.map((strength, i) => (
                          <li key={i} className="flex gap-3 text-sm font-light text-neutral-300">
                  ...
                  {aggregatedReport.recommendations && aggregatedReport.recommendations.length > 0 && (
                    <div className="border border-white/10 bg-[#1E1E1E] p-8 rounded-xl">
                      <h2 className="text-xl font-medium mb-6 text-white">Prioritized Recommendations</h2>
                      <div className="space-y-4">
                        {aggregatedReport.recommendations.map((rec, i) => (
                          <div key={i} className="border-l-4 border-l-white/20 pl-6 py-2">
                            <div className="flex items-start gap-3 mb-2">
                              <span className={`text-xs px-2 py-1 font-medium uppercase border rounded-lg ${getPriorityColor(rec.priority)}`}>
                                {rec.priority}
                              </span>
                              <h3 className="font-medium flex-1 text-white">{rec.recommendation}</h3>
                            </div>
                  ...
                  {aggregatedReport.personaSpecificInsights && aggregatedReport.personaSpecificInsights.length > 0 && (
                    <div className="border border-white/10 bg-[#1E1E1E] p-8 rounded-xl">
                      <h2 className="text-xl font-medium mb-6 text-white">Persona-Specific Insights</h2>
                      <div className="grid md:grid-cols-2 gap-4">
                        {aggregatedReport.personaSpecificInsights.map((insight, i) => (
                          <div key={i} className="p-5 bg-[#252525] border border-white/5 rounded-lg">
                            <h3 className="font-medium mb-3 text-white">{insight.personaName}</h3>
                            <ul className="space-y-2 text-sm font-light">
                              {insight.keyFindings.map((finding, j) => (
                                <li key={j} className="text-neutral-300 flex gap-2">
                  ...
                  {aggregatedReport.fullAnalysis && (
                    <div className="border border-white/10 bg-[#1E1E1E] p-8 rounded-xl">
                      <h2 className="text-xl font-medium mb-6 text-white">Detailed Analysis</h2>
                      <div className="prose prose-invert max-w-none text-neutral-300 font-light leading-relaxed">
                        <ReactMarkdown
                          components={{
                            h3: ({ children }) => <h3 className="text-lg font-medium mt-6 mb-3 text-white">{children}</h3>,
                            p: ({ children }) => <p className="mb-4 text-neutral-300">{children}</p>,
                            ul: ({ children }) => <ul className="list-disc list-inside mb-4 space-y-1 text-neutral-300">{children}</ul>,
                            ol: ({ children }) => <ol className="list-decimal list-inside mb-4 space-y-1 text-neutral-300">{children}</ol>,
                ...
                <div className="space-y-8">
                  {/* Persona Profile */}
                  <div className="border border-white/10 bg-[#252525] p-8 rounded-xl">
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <button
                        ...
                        className="flex items-center gap-2 px-4 py-2 bg-[#1E1E1E] border border-white/10 text-white hover:bg-[#252525] transition-colors text-sm font-medium rounded-lg"
                      >
                        <Play size={16} />
                        View Session
                      </button>
                    ...
                    {testRuns[selectedView].testRun.personaData && (
                      <div className="grid md:grid-cols-3 gap-6 text-sm">
                        <div>
                          <p className="text-neutral-400 text-xs uppercase tracking-wide mb-1 font-light">Profile</p>
                        ...
                        <div>
                          <p className="text-neutral-400 text-xs uppercase tracking-wide mb-1 font-light">Location</p>
                          <p className="font-light text-neutral-300">{testRuns[selectedView].testRun.personaData.country}</p>
                        </div>
                        <div>
                          <p className="text-neutral-400 text-xs uppercase tracking-wide mb-1 font-light">Tech Level</p>
                  ...
                  {/* Score */}
                  <div className="border border-white/10 bg-[#1E1E1E] p-8 rounded-xl">
                    <h3 className="text-lg font-light mb-4 text-white">Individual Score</h3>
                    ...
                    {testRuns[selectedView].report?.summary && (
                      <p className="mt-4 text-neutral-300 font-light">{testRuns[selectedView].report.summary}</p>
                    )}
                  </div>
                  ...
                  {testRuns[selectedView].report?.positiveAspects && testRuns[selectedView].report.positiveAspects!.length > 0 && (
                    <div className="border border-white/10 bg-[#1E1E1E] p-8 rounded-xl">
                      <h3 className="text-lg font-light mb-4 text-white">What Worked</h3>
                      <ul className="space-y-2">
                  ...
                  {testRuns[selectedView].report?.accessibilityNotes && testRuns[selectedView].report.accessibilityNotes!.length > 0 && (
                    <div className="border border-white/10 bg-[#1E1E1E] p-8 rounded-xl">
                      <h3 className="text-lg font-light mb-4 text-white">Confusion Points</h3>
                      <ul className="space-y-2">
                  ...
                  {testRuns[selectedView].report?.usabilityIssues && testRuns[selectedView].report.usabilityIssues!.length > 0 && (
                    <div className="border border-white/10 bg-[#1E1E1E] p-8 rounded-xl">
                      <h3 className="text-lg font-light mb-4 text-white">Usability Issues</h3>
                      <div className="space-y-3">
                        {testRuns[selectedView].report!.usabilityIssues!.map((issue: any, i: number) => (
                          <div key={i} className={`border-l-4 p-4 rounded-lg ${getSeverityColor(issue.severity)}`}>
                            ...
                            <p className="text-sm mb-2 font-light text-neutral-300">{issue.description}</p>
                            {issue.recommendation && (
                              <p className="text-sm text-neutral-400 font-light">{issue.recommendation}</p>
                            )}
                          </div>
                        ))}
                      </div>
                  ...
                  {testRuns[selectedView].report?.recommendations && testRuns[selectedView].report.recommendations!.length > 0 && (
                    <div className="border border-white/10 bg-[#1E1E1E] p-8 rounded-xl">
                      <h3 className="text-lg font-light mb-4 text-white">Recommendations</h3>
                      <ol className="list-decimal list-inside space-y-2 text-sm font-light text-neutral-300">
                ...
                <div className="space-y-6">
                  {!batchTestRun?.useUXAgent || uxagentRuns.length === 0 ? (
                    <div className="border border-white/10 bg-[#1E1E1E] p-12 text-center rounded-xl">
                      ...
                      <h3 className="text-lg font-medium text-white mb-2">Swarm Agents</h3>
                        ...
                        {uxagentRuns.slice(0, 3).map((run, idx) => {
                          ...
                          return (
                            <button
                              ...
                              className={`flex-1 px-4 py-3 text-left transition-all rounded-lg border ${
                                isSelected
                            ...
                            >
                              <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                  ...
                                  <span className={`font-medium text-sm ${isSelected ? "text-white" : "text-neutral-300"}`}>
                                    {agentName}
                                  </span>
                                </div>
                                {run.score !== null && (
                                  <span className={`text-sm font-light ${isSelected ? "text-white" : "text-neutral-400"}`}>
                                    {run.score}/10
                                  </span>
                                )}
                              </div>
                      ...
                      {selectedSwarmAgentIndex !== null && uxagentRuns[selectedSwarmAgentIndex] && (() => {
                        ...
                        return (
                          <div className="space-y-6">
                            ...
                            <div className="border border-white/10 bg-[#1E1E1E] p-4 rounded-xl">
                              <div className="flex items-center justify-between">
                                <div>
                                  <h2 className="text-lg font-medium text-white">{getSwarmAgentName(selectedRun, selectedSwarmAgentIndex)}</h2>
                                  <p className="text-neutral-400 text-xs font-light mt-0.5">{selectedRun.intent}</p>
                                </div>
                                <div className="flex items-center gap-4 text-sm">
                                  <span className="text-neutral-400 font-light">{selectedRun.stepsTaken || 0} steps</span>
                                  <span className="text-neutral-400 font-light">{selectedRun.screenshots?.length || 0} screenshots</span>
                                  {selectedRun.score !== null && (
                                    <span className="text-white font-medium">{selectedRun.score}/10</span>
                                  )}
                            ...
                            <div className="min-h-[400px]">
                              {swarmAgentActiveTab === "overview" && (
                                <div className="space-y-4">
                                  ...
                                  {selectedRun.errorMessage && (
                                    <div className="border-l-4 border-red-500 bg-red-500/10 p-3 rounded-lg">
                                      <div className="flex items-center gap-2 text-red-400 font-medium mb-1 text-sm">
                                        <AlertCircle size={14} />
                                        Error
                                      </div>
                                      <p className="text-red-300 text-sm font-light">{selectedRun.errorMessage}</p>
                                    </div>
                                  )}
                                  ...
                                  {Object.keys(timingMetrics).length > 0 && (
                                    <div className="border border-white/10 bg-[#1E1E1E] p-4 rounded-xl">
                                      <h3 className="text-sm font-medium mb-3 text-white">Timing Metrics</h3>
                                      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                                        <div>
                                          <p className="text-xs text-neutral-400 font-light mb-1">Duration</p>
                                          <p className="text-sm font-light text-white">{(timingMetrics.total_duration_ms / 1000).toFixed(1)}s</p>
                                        </div>
                                        <div>
                                          <p className="text-xs text-neutral-400 font-light mb-1">First Action</p>
                                          <p className="text-sm font-light text-white">{(timingMetrics.time_to_first_action_ms / 1000).toFixed(1)}s</p>
                                        </div>
                                        <div>
                                          <p className="text-xs text-neutral-400 font-light mb-1">Avg Interval</p>
                                          <p className="text-sm font-light text-white">{(timingMetrics.average_action_interval_ms / 1000).toFixed(1)}s</p>
                                        </div>
                                        <div>
                                          <p className="text-xs text-neutral-400 font-light mb-1">Backtracks</p>
                                          <p className="text-sm font-light text-white">{timingMetrics.backtrack_count || 0}</p>
                                        </div>
                                      </div>
                                    </div>
                                  )}
                                  ...
                                  {observations.length > 0 && (
                                    <div className="border border-white/10 bg-[#1E1E1E] p-4 rounded-xl">
                                      <h3 className="text-sm font-medium mb-3 text-white">Pages Visited</h3>
                                      <div className="space-y-2">
                                        {observations.slice(0, 5).map((obs: any, idx: number) => (
                                          <div key={idx} className="flex items-center gap-2 text-sm">
                                            ...
                                            <span className="text-neutral-300 font-light truncate">{obs.url || "Page Visit"}</span>
                                          </div>
                                        ))}
                                        {observations.length > 5 && (
                                          <p className="text-xs text-neutral-500 font-light mt-2">+{observations.length - 5} more pages</p>
                                        )}
                                      </div>
                                    </div>
                                  )}
                              ...
                              {swarmAgentActiveTab === "actions" && (
                                <div className="border border-white/10 bg-[#1E1E1E] rounded-xl overflow-hidden">
                                  <div className="p-4 bg-[#252525] border-b border-white/10">
                                    ...
                                    <p className="text-sm text-neutral-400 font-light">{selectedRun.actionTrace?.length || 0} actions recorded</p>
                                  </div>
                                          ...
                                          <div className="flex-1 min-w-0">
                                            <div className="flex items-center gap-2 mb-1">
                                              <span className={`px-2 py-0.5 text-xs font-medium rounded ${
                                                action.action === "click" ? "bg-blue-500/10 text-blue-400 border border-blue-500/20" :
                                      ...
                                      {memories.slice(-50).reverse().map((memory: any, idx: number) => (
                                        ...
                                        >
                                          ...
                                          >
                                            ...
                                            {swarmMemoryExpanded === idx ? <ChevronUp size={16} className="text-neutral-400" /> : <ChevronDown size={16} className="text-neutral-400" />}
                                          </button>
                              ...
                              {swarmAgentActiveTab === "insights" && (
                                <div className="border border-white/10 bg-[#1E1E1E] p-6 rounded-xl">
                                  <h3 className="text-lg font-medium mb-4 text-white">UX Insights</h3>
                                  {basicInfo.ux_evaluation ? (
                                    <div className="space-y-4">
                                      <pre className="text-sm text-neutral-300 whitespace-pre-wrap font-light bg-[#252525] p-4 rounded-lg border border-white/5">
                                        {JSON.stringify(basicInfo.ux_evaluation, null, 2)}
                                      </pre>
                                    </div>
                                  ) : (
                                    <p className="text-neutral-400 font-light">No UX evaluation data available.</p>
                                  )}
                                </div>
                              )}
                              ...
                              {swarmAgentActiveTab === "logs" && (
                                <div className="border border-white/10 bg-[#1E1E1E] p-6 rounded-xl">
                                  ...
                                  {selectedRun.logContent ? (
                                    <div className="bg-[#252525] p-4 max-h-[500px] overflow-y-auto rounded-lg border border-white/5">
                                      <pre className="text-xs font-mono text-neutral-300 whitespace-pre-wrap">
                                        {selectedRun.logContent}
                                      </pre>
                                    </div>
                                  ) : (
                                    <p className="text-neutral-400 font-light">No log content available.</p>
                                  )}
                                </div>
                              )}
                            </div>
              ...
              {activeMainTab === "test-details" && (
                <div className="space-y-6">
                  {/* Test Configuration */}
                  <div className="border border-white/10 bg-[#1E1E1E] p-6 rounded-xl">
                    <h2 className="text-xl font-medium mb-6 text-white">Test Configuration</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        <p className="text-xs font-medium text-neutral-400 uppercase tracking-wide mb-2">Target URL</p>
                        <a
                          href={batchTestRun.targetUrl}
                          target="_blank"
                          rel="noopener noreferrer"
                          className="text-sm font-light text-neutral-300 hover:text-white flex items-center gap-2 group"
                        >
                      ...
                      <div>
                        <p className="text-xs font-medium text-neutral-400 uppercase tracking-wide mb-2">Test Mode</p>
                        <p className="text-sm font-light text-white">{batchTestRun.useUXAgent ? "UXAgent" : "Standard"}</p>
                      </div>
                      <div>
                        <p className="text-xs font-medium text-neutral-400 uppercase tracking-wide mb-2">Number of Agents</p>
                        <p className="text-sm font-light text-white">{testRuns.length} agents</p>
                      </div>
                      <div>
                        <p className="text-xs font-medium text-neutral-400 uppercase tracking-wide mb-2">Status</p>
                        {getStatusBadge(batchTestRun.status)}
                      </div>
                    </div>
                  </div>
                  ...
                  {/* Target Audience */}
                  <div className="border border-white/10 bg-[#1E1E1E] p-6 rounded-xl">
                    <h2 className="text-xl font-medium mb-4 text-white">Target Audience</h2>
                  ...
                  {batchTestRun.generatedPersonas && batchTestRun.generatedPersonas.length > 0 && (
                    <div className="border border-white/10 bg-[#1E1E1E] p-6 rounded-xl">
                      <h2 className="text-xl font-medium mb-6 text-white">Test Personas</h2>
                        ...
                        {batchTestRun.generatedPersonas.map((persona: any, idx: number) => {
                          ...
                          return (
                            <button
                              ...
                              className={`w-full text-left border rounded-lg p-4 transition-all hover:border-white/30 ${isSelected
                                ? "border-white/20 bg-[#252525]"
                            ...
                            >
                              <div className="flex items-start justify-between mb-3">
                                <div>
                                  <h3 className="font-medium text-white mb-1">
                                    ...
                                    {!isSelected && <span className="text-xs text-neutral-500 ml-2">(Not Selected)</span>}
                                  </h3>
                              ...
                              {persona.primaryGoal && (
                                <div className="mb-2">
                                  <p className="text-xs text-neutral-400 uppercase tracking-wide mb-1">Primary Goal</p>
                                  <p className="text-sm text-neutral-300 font-light">{persona.primaryGoal}</p>
                                </div>
                              )}
                              
                              {persona.painPoints && persona.painPoints.length > 0 && (
                                <div>
                                  <p className="text-xs text-neutral-400 uppercase tracking-wide mb-1">Pain Points</p>
                                  <ul className="space-y-1">
                                    {persona.painPoints.slice(0, 2).map((point: string, i: number) => (
                                      <li key={i} className="text-sm text-neutral-300 font-light flex gap-2">
                              ...
                              {persona.background && (
                                <div className="mt-3 pt-3 border-t border-white/5">
                                  <p className="text-xs text-neutral-400 uppercase tracking-wide mb-1">Background</p>
                                  <p className="text-sm text-neutral-300 font-light line-clamp-2">{persona.background}</p>
                                </div>
                              )}

                              {testRun && testRun.testRun.startedAt && testRun.testRun.completedAt && (
                                <div className="mt-3 pt-3 border-t border-white/5">
                                  <p className="text-xs text-neutral-400 uppercase tracking-wide mb-1">Duration</p>
                                  <p className="text-sm text-neutral-300 font-light">
                  ...
                  {/* Timestamps */}
                  <div className="border border-white/10 bg-[#1E1E1E] p-6 rounded-xl">
                    <h2 className="text-xl font-medium mb-6 text-white">Timestamps</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        <p className="text-xs font-medium text-neutral-400 uppercase tracking-wide mb-2">Created</p>
                      ...
                      {batchTestRun.completedAt && (
                        <div>
                          <p className="text-xs font-medium text-neutral-400 uppercase tracking-wide mb-2">Completed</p>
                          <p className="text-sm font-light text-white">
                      ...
                      {batchTestRun.completedAt && batchTestRun.createdAt && (
                        <div className="md:col-span-2">
                          <p className="text-xs font-medium text-neutral-400 uppercase tracking-wide mb-2">Total Duration</p>
                          <p className="text-sm font-light text-white">
                  ...
                  {testRuns.length > 0 && (
                    <div className="border border-white/10 bg-[#1E1E1E] p-6 rounded-xl">
                      <h2 className="text-xl font-medium mb-6 text-white">Agent Status Summary</h2>
                      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                        <div className="bg-[#252525] p-4 border border-white/5 rounded-lg">
                          <p className="text-xs text-neutral-400 uppercase tracking-wide font-light mb-1">Total</p>
                          <p className="text-2xl font-light text-white">{testRuns.length}</p>
                        </div>
                        <div className="bg-[#252525] p-4 border border-white/5 rounded-lg">
                          <p className="text-xs text-neutral-400 uppercase tracking-wide font-light mb-1">Completed</p>
                          <p className="text-2xl font-light text-emerald-400">
                            {testRuns.filter(t => t.testRun.status === "completed").length}
                          </p>
                        </div>
                        <div className="bg-[#252525] p-4 border border-white/5 rounded-lg">
                          <p className="text-xs text-neutral-400 uppercase tracking-wide font-light mb-1">Running</p>
                          <p className="text-2xl font-light text-blue-400">
                            {testRuns.filter(t => t.testRun.status === "running").length}
                          </p>
                        </div>
                        <div className="bg-[#252525] p-4 border border-white/5 rounded-lg">
                          <p className="text-xs text-neutral-400 uppercase tracking-wide font-light mb-1">Failed</p>
                  ...
                  {batchTestRun.errorMessage && (
                    <div className="border-l-4 border-red-500 bg-red-500/10 p-4 rounded-lg">
                      ...
                      <p className="text-red-300 text-sm font-light">{batchTestRun.errorMessage}</p>
                    </div>
                  )}
                </div>
              )}
      ...
      {showTerminateConfirm && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-[60] flex items-center justify-center p-4">
          <div className="bg-[#1E1E1E] border border-white/10 p-6 max-w-sm w-full shadow-2xl animate-in fade-in zoom-in-95 duration-200 rounded-xl">
            <h3 className="text-lg font-medium text-white mb-2">Terminate Test</h3>
            ...
            <div className="flex justify-end gap-3">
              <button
                ...
                className="px-4 py-2 text-sm text-neutral-400 hover:text-white hover:bg-white/5 transition-colors rounded-lg"
              >
                Cancel
              </button>
              <button
                ...
                disabled={isTerminating}
                className="px-4 py-2 text-sm bg-orange-500/10 text-orange-400 border border-orange-500/20 hover:bg-orange-500/20 transition-colors shadow-sm rounded-lg disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
              >
                {isTerminating ? (
                  <>
                    <Loader2 size={14} className="animate-spin" />
      ...
      {selectedPersonaDetail && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-[60] flex items-center justify-center p-4">
          <div className="bg-[#1E1E1E] border border-white/10 p-8 max-w-3xl w-full max-h-[90vh] overflow-y-auto shadow-2xl animate-in fade-in zoom-in-95 duration-200 rounded-xl">
            <div className="flex items-start justify-between mb-6">
              ...
              <button
                ...
                className="p-2 hover:bg-white/5 transition-colors rounded-lg text-neutral-400 hover:text-white"
              >
                <X size={20} />
              </button>
            </div>
            ...
            <div className="space-y-6">
              {/* Demographics */}
              <div className="border border-white/10 bg-[#252525] p-6 rounded-lg">
                <h3 className="text-lg font-medium mb-4 text-white">Demographics</h3>
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  {selectedPersonaDetail.persona.age && (
                    <div>
                      <p className="text-xs text-neutral-400 uppercase tracking-wide mb-1 font-light">Age</p>
                      <p className="text-sm font-light text-white">{selectedPersonaDetail.persona.age} years old</p>
                    </div>
                  )}
                  {selectedPersonaDetail.persona.gender && (
                    <div>
                      <p className="text-xs text-neutral-400 uppercase tracking-wide mb-1 font-light">Gender</p>
                      <p className="text-sm font-light text-white capitalize">{selectedPersonaDetail.persona.gender}</p>
                    </div>
                  )}
                  {selectedPersonaDetail.persona.maritalStatus && (
                    <div>
                      <p className="text-xs text-neutral-400 uppercase tracking-wide mb-1 font-light">Marital Status</p>
                      <p className="text-sm font-light text-white capitalize">{selectedPersonaDetail.persona.maritalStatus}</p>
                    </div>
                  )}
                  {selectedPersonaDetail.persona.country && (
                    <div>
                      <p className="text-xs text-neutral-400 uppercase tracking-wide mb-1 font-light">Country</p>
                      <p className="text-sm font-light text-white">{selectedPersonaDetail.persona.country}</p>
                    </div>
                  )}
                  {selectedPersonaDetail.persona.occupation && (
                    <div>
                      <p className="text-xs text-neutral-400 uppercase tracking-wide mb-1 font-light">Occupation</p>
                      <p className="text-sm font-light text-white">{selectedPersonaDetail.persona.occupation}</p>
                    </div>
                  )}
                  {selectedPersonaDetail.persona.education && (
                    <div>
                      <p className="text-xs text-neutral-400 uppercase tracking-wide mb-1 font-light">Education</p>
                      <p className="text-sm font-light text-white">{selectedPersonaDetail.persona.education}</p>
                    </div>
                  )}
                  {selectedPersonaDetail.persona.incomeLevel && (
                    <div>
                      <p className="text-xs text-neutral-400 uppercase tracking-wide mb-1 font-light">Income Level</p>
                      <p className="text-sm font-light text-white capitalize">{selectedPersonaDetail.persona.incomeLevel}</p>
                    </div>
                  )}
                  {selectedPersonaDetail.persona.income && (
                    <div>
                      <p className="text-xs text-neutral-400 uppercase tracking-wide mb-1 font-light">Income</p>
                      <p className="text-sm font-light text-white">{selectedPersonaDetail.persona.income}</p>
                    </div>
                  )}
                  {selectedPersonaDetail.persona.techSavviness && (
                    <div>
                      <p className="text-xs text-neutral-400 uppercase tracking-wide mb-1 font-light">Tech Savviness</p>
                      <p className="text-sm font-light text-white capitalize">{selectedPersonaDetail.persona.techSavviness}</p>
                    </div>
                  )}
                </div>
              </div>
              ...
              {/* Goals & Pain Points */}
              <div className="border border-white/10 bg-[#252525] p-6 rounded-lg">
                <h3 className="text-lg font-medium mb-4 text-white">Goals & Pain Points</h3>
                {selectedPersonaDetail.persona.primaryGoal && (
                  <div className="mb-4">
                    <p className="text-xs text-neutral-400 uppercase tracking-wide mb-2 font-light">Primary Goal</p>
                    <p className="text-sm font-light text-white">{selectedPersonaDetail.persona.primaryGoal}</p>
                  </div>
                )}
                {selectedPersonaDetail.persona.painPoints && selectedPersonaDetail.persona.painPoints.length > 0 && (
                  <div>
                    <p className="text-xs text-neutral-400 uppercase tracking-wide mb-2 font-light">Pain Points</p>
                    <ul className="space-y-2">
                      {selectedPersonaDetail.persona.painPoints.map((point: string, i: number) => (
                        <li key={i} className="text-sm font-light text-white flex gap-2">
              ...
              {(selectedPersonaDetail.persona.background || selectedPersonaDetail.persona.context) && (
                <div className="border border-white/10 bg-[#252525] p-6 rounded-lg">
                  <h3 className="text-lg font-medium mb-4 text-white">Background & Context</h3>
                  {selectedPersonaDetail.persona.background && (
                    <div className="mb-4">
                      <p className="text-xs text-neutral-400 uppercase tracking-wide mb-2 font-light">Background</p>
                      <p className="text-sm font-light text-white leading-relaxed whitespace-pre-wrap">{selectedPersonaDetail.persona.background}</p>
                    </div>
                  )}
                  {selectedPersonaDetail.persona.context && (
                    <div>
                      <p className="text-xs text-neutral-400 uppercase tracking-wide mb-2 font-light">Context</p>
                      <p className="text-sm font-light text-white leading-relaxed whitespace-pre-wrap">{selectedPersonaDetail.persona.context}</p>
                    </div>
                  )}
                </div>
              )}
              ...
              {(selectedPersonaDetail.persona.financialSituation || 
                ...
                <div className="border border-white/10 bg-[#252525] p-6 rounded-lg">
                  ...
                  {selectedPersonaDetail.persona.financialSituation && (
                    <div className="mb-4">
                      <p className="text-xs text-neutral-400 uppercase tracking-wide mb-2 font-light">Financial Situation</p>
                      <p className="text-sm font-light text-white leading-relaxed">{selectedPersonaDetail.persona.financialSituation}</p>
                    </div>
                  )}
                  {selectedPersonaDetail.persona.browsingHabits && (
                    <div className="mb-4">
                      <p className="text-xs text-neutral-400 uppercase tracking-wide mb-2 font-light">Browsing Habits</p>
                      <p className="text-sm font-light text-white leading-relaxed">{selectedPersonaDetail.persona.browsingHabits}</p>
                    </div>
                  )}
                  {selectedPersonaDetail.persona.professionalLife && (
                    <div className="mb-4">
                      <p className="text-xs text-neutral-400 uppercase tracking-wide mb-2 font-light">Professional Life</p>
                      <p className="text-sm font-light text-white leading-relaxed">{selectedPersonaDetail.persona.professionalLife}</p>
                    </div>
                  )}
                  {selectedPersonaDetail.persona.personalStyle && (
                    <div>
                      <p className="text-xs text-neutral-400 uppercase tracking-wide mb-2 font-light">Personal Style</p>
                      <p className="text-sm font-light text-white leading-relaxed">{selectedPersonaDetail.persona.personalStyle}</p>
                    </div>
                  )}
                </div>
              )}
              ...
              {selectedPersonaDetail.persona.relevanceScore !== undefined && (
                <div className="border border-white/10 bg-[#252525] p-6 rounded-lg">
                  <h3 className="text-lg font-medium mb-4 text-white">Selection Metrics</h3>
                  <div>
                    <p className="text-xs text-neutral-400 uppercase tracking-wide mb-2 font-light">Relevance Score</p>
                    <div className="flex items-center gap-4">
                      <p className="text-2xl font-light text-white">{selectedPersonaDetail.persona.relevanceScore.toFixed(2)}</p>
                      <div className="flex-1">
                        <div className="h-2 bg-white/10 overflow-hidden rounded-full">
                          <div
                            className="h-full bg-white transition-all"
              ...
              {(() => {
                ...
                return (
                  <div className="border border-white/10 bg-[#252525] p-6 rounded-lg">
                    <h3 className="text-lg font-medium mb-4 text-white">Test Run Status</h3>
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <p className="text-xs text-neutral-400 uppercase tracking-wide mb-1 font-light">Status</p>
                        <div className="flex items-center gap-2">
                          {testRun.testRun.status === "completed" ? (
                          ...
                          <p className="text-sm font-light text-white capitalize">{testRun.testRun.status}</p>
                        </div>
                      </div>
                      {testRun.testRun.startedAt && testRun.testRun.completedAt && (
                        <div>
                          <p className="text-xs text-neutral-400 uppercase tracking-wide mb-1 font-light">Duration</p>
                          <p className="text-sm font-light text-white">
                            {Math.round((new Date(testRun.testRun.completedAt).getTime() - new Date(testRun.testRun.startedAt).getTime()) / 1000)}s
                          </p>
                        </div>
                      ...
                      {testRun.report && testRun.report.score !== null && (
                        <div>
                          <p className="text-xs text-neutral-400 uppercase tracking-wide mb-1 font-light">Score</p>
                          <p className="text-sm font-light text-white">{testRun.report.score}/10</p>
                        </div>
                      )}
                    </div>
                  </div>
