...
export default function NewTest() {
  ...
  const handleStartScreenshotTest = async () => {
                        ...
                        <div className="flex items-center justify-between mb-3">
                          ...
                          {url && (
                            <button
                              ...
                              className={`px-3 py-1.5 border transition-all text-xs font-medium flex items-center gap-2 rounded-lg ${isLight
              ...
              <div className="flex-shrink-0">
                <div className={`border rounded-xl p-6 ${isLight
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2 transition-colors w-full ${isLight
                      ? "text-neutral-600 hover:text-neutral-900"
                      : "text-neutral-400 hover:text-white"
                      }`}
                  >
                  ...
                  {showAdvancedSettings && (
                    <div className={`space-y-4 pt-4 mt-4 border-t ${isLight ? "border-neutral-200" : "border-white/10"
                      }`}>
                      {/* Legacy Mode Toggle */}
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          ...
                          className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${!useUXAgent
                            ? isLight ? 'bg-neutral-900' : 'bg-white'
                            : isLight ? 'bg-neutral-200 border border-neutral-300' : 'bg-[#252525] border border-white/10'
                            }`}
                        >
                          <span
                            className={`inline-block h-4 w-4 transform rounded-full transition-transform ${!useUXAgent
                      ...
                      {!useUXAgent && (
                        <div className={`p-3 border text-xs font-light rounded-lg ${isLight
      ...
      {step === "select" && (
        <>
          ...
          <div className="space-y-6">
            {/* Selection Status */}
            <div className={`flex items-center gap-3 p-3 border rounded-lg ${isLight
              ? "border-neutral-200 bg-white"
              : "border-white/10 bg-[#1E1E1E]"
              }`}>
              <div className="flex-1">
                <div className="flex items-center gap-4">
                  <span className={`text-xs font-medium ${selectedIndices.length === agentCount
                  ...
                  <div className="flex gap-1 flex-1 max-w-xs">
                    {[...Array(agentCount)].map((_, i) => (
                      <div
                        key={i}
                        className={`h-1 flex-1 transition-colors rounded-full ${i < selectedIndices.length
                          ? isLight ? 'bg-neutral-900' : 'bg-white'
              ...
              {personas.map((persona, index) => {
                ...
                return (
                  <div
                    ...
                    className={`group cursor-pointer p-4 border transition-all duration-200 relative rounded-xl ${isSelected
                      ? isLight
                  ...
                  >
                    {isRecommended && (
                      <div className={`absolute top-2 right-2 px-1.5 py-0.5 text-[9px] font-medium uppercase tracking-wide rounded-md ${isLight
                    ...
                    <div className="flex justify-between items-start mb-3">
                      <div>
                        <h3 className={`font-medium text-base mb-1 ${isLight ? "text-neutral-900" : "text-white"
                          }`}>{persona.name}</h3>
                        <div className={`text-xs font-light flex items-center gap-2 ${isLight ? "text-neutral-600" : "text-neutral-400"
                          }`}>
                    ...
                    <p className={`text-xs font-light leading-relaxed mb-3 line-clamp-2 ${isLight ? "text-neutral-600" : "text-neutral-400"
                      }`}>
                      {persona.primaryGoal}
                    </p>

                    <div className={`text-xs ${isLight ? "text-neutral-500" : "text-neutral-500"
                      }`}>
                    ...
                    {/* Selection Indicator */}
                    {isSelected && (
                      <div className={`absolute top-0 left-0 w-0 h-0 border-t-[24px] border-r-[24px] border-r-transparent rounded-tl-xl ${isLight
                        ? "border-t-neutral-900"
                        : "border-t-white"
                        }`}>
                        <Check size={12} className={`absolute -top-[22px] left-[2px] ${isLight ? "text-white" : "text-neutral-900"
                          }`} />
                      </div>
                    )}
                  </div>
            ...
            <div className={`flex items-start gap-3 p-3 border text-xs font-light rounded-lg ${isLight
            ...
            {/* Actions */}
            <div className={`flex items-center justify-between gap-4 pt-4 border-t ${isLight ? "border-neutral-200" : "border-white/10"
              }`}>
              <button
                onClick={() => setStep("describe")}
                className={`px-5 py-2 text-sm font-medium transition-colors ${isLight
                  ? "text-neutral-600 hover:text-neutral-900"
                  : "text-neutral-400 hover:text-white"
                  }`}
              >
      ...
      {step === "starting" && (
        <>
          ...
          <div className="flex flex-col items-center justify-center min-h-[400px] text-center">
            ...
            {selectedSwarm && (
              <p className={`text-sm font-light mt-2 ${isLight ? "text-neutral-600" : "text-neutral-500"
                }`}>
                Using swarm: <span className={`font-medium ${isLight ? "text-neutral-900" : "text-white"
                  }`}>{selectedSwarm.name}</span>
              </p>
            )}
            <p className={`text-xs font-light mt-2 ${isLight ? "text-neutral-500" : "text-neutral-600"
              }`}>
        ...
        {showSwarmSelector && (
          ...
          >
            <motion.div
              ...
              className={`w-full max-w-3xl max-h-[85vh] overflow-hidden shadow-2xl rounded-xl flex flex-col relative border ${isLight
                ? "bg-white border-neutral-200"
                : "bg-[#1E1E1E] border-white/10"
                }`}
              ...
              <div className="relative overflow-hidden flex-1 flex">
                ...
                <AnimatePresence mode="wait">
                  {swarmModalStep === "select" && (
                    ...
                    >
                      {/* Header */}
                      <div className={`p-6 border-b flex items-start justify-between shrink-0 ${isLight
                        ? "border-neutral-200 bg-white"
                        : "border-white/10 bg-[#1E1E1E]"
                        }`}>
                        <div className="flex-1">
                          <h2 className={`text-2xl font-light mb-1 ${isLight ? "text-neutral-900" : "text-white"
                            }`}>Select a Swarm</h2>
                        ...
                        <button
                          ...
                          className={`ml-4 p-2 transition-colors rounded-lg ${isLight
                      ...
                      <div className="flex-1 overflow-y-auto p-6">
                        {isLoadingSwarms ? (
                          ...
                          <div className="text-center py-12">
                            <Users size={48} className={`mx-auto mb-4 ${isLight ? "text-neutral-400" : "text-neutral-600"
                              }`} />
                            <p className={`font-light ${isLight ? "text-neutral-600" : "text-neutral-500"
                              }`}>No swarms available</p>
                            <Link
                              href="/dashboard/swarms/new"
                              className={`text-sm underline mt-2 inline-block ${isLight
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {swarms.map((swarm) => (
                              <button
                                ...
                                className={`p-6 border transition-all text-left group rounded-xl ${isLight
                                  ? "border-neutral-200 hover:border-neutral-400 hover:bg-neutral-50 bg-white"
                              ...
                              >
                                <div className="flex items-start justify-between mb-3">
                                  <div className="flex-1">
                                    <h3 className={`font-medium text-lg mb-1 transition-colors ${isLight
                                    ...
                                    {swarm.description && (
                                      <p className={`text-xs font-light line-clamp-2 ${isLight ? "text-neutral-600" : "text-neutral-400"
                                        }`}>
                                        {swarm.description}
                                      </p>
                                    )}
                                ...
                                <div className={`flex items-center gap-4 text-xs font-mono uppercase tracking-wider ${isLight ? "text-neutral-500" : "text-neutral-500"
                                  }`}>
                                ...
                                <div className={`mt-4 pt-4 border-t ${isLight ? "border-neutral-200" : "border-white/10"
                                  }`}>
                                  <div className={`flex items-center gap-2 text-xs transition-colors ${isLight
                    ...
                    >
                      ...
                      <div className={`p-6 border-b flex items-start justify-between shrink-0 ${isLight
                        ...
                        <div className="flex-1">
                          ...
                          <p className={`font-light text-sm ${isLight ? "text-neutral-600" : "text-neutral-400"
                            ...
                            Ready to deploy {selectedSwarm.agentCount} agent{selectedSwarm.agentCount !== 1 ? 's' : ''} using <span className={`font-medium ${isLight ? "text-neutral-900" : "text-white"
                              }`}>{selectedSwarm.name}</span>
                          </p>
                        </div>
                        <button
                      ...
                      <div className="flex-1 overflow-y-auto p-6">
                        <div className="max-w-md mx-auto text-center py-12">
                          <div className="mb-6">
                            <div className={`w-16 h-16 mx-auto mb-4 border-2 flex items-center justify-center rounded-full ${isLight
                              ? "border-neutral-900"
                              : "border-white"
                              }`}>
                              <Users size={32} className={isLight ? "text-neutral-900" : "text-white"} />
                            </div>
                            <h3 className={`text-xl font-light mb-2 ${isLight ? "text-neutral-900" : "text-white"
                              }`}>{selectedSwarm.name}</h3>
                            {selectedSwarm.description && (
                              <p className={`text-sm font-light mb-4 ${isLight ? "text-neutral-600" : "text-neutral-400"
                                }`}>
                                {selectedSwarm.description}
                              </p>
                            )}
                          ...
                          <div className={`space-y-3 text-left p-4 border mb-6 rounded-xl ${isLight
                            ...
                            <div className="flex items-center justify-between text-sm">
                              ...
                              <span className={`font-medium text-xs truncate max-w-[200px] ${isLight ? "text-neutral-900" : "text-white"
                                }`} title={url}>
                                {url}
                              </span>
                            </div>
                            <div className={`flex items-center justify-between text-sm pt-2 border-t ${isLight ? "border-neutral-200" : "border-white/10"
                              }`}>
                              <div className="flex items-center gap-2">
                              ...
                              <span className={`text-xs px-2 py-0.5 rounded-full ${useUXAgent
                                ? isLight
                          ...
                          {!useUXAgent && (
                            <div className={`p-3 border text-xs font-light mb-6 text-left rounded-lg ${isLight
                              ? "bg-amber-50 border-amber-200 text-amber-700"
                              : "bg-amber-500/10 border-amber-500/20 text-amber-400"
                              }`}>
                          ...
                          <p className={`text-xs font-light mb-6 text-left ${isLight ? "text-neutral-500" : "text-neutral-500"
                            }`}>
                      ...
                      {/* Footer */}
                      <div className={`p-6 border-t shrink-0 ${isLight
                        ? "border-neutral-200 bg-white"
                        : "border-white/10 bg-[#1E1E1E]"
                        }`}>
                        <div className="flex items-center justify-between gap-4">
                          <button
                            ...
                            className={`px-6 py-2 text-sm font-medium transition-colors ${isLight
                              ? "text-neutral-600 hover:text-neutral-900"
                              : "text-neutral-400 hover:text-white"
                              }`}
                          >
                          ...
                          <button
                            ...
                            disabled={loading}
                            className={`px-8 py-2 transition-all text-sm font-medium flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed rounded-lg ${isLight
                              ? "bg-neutral-900 text-white hover:bg-neutral-800"
                              : "bg-white text-neutral-900 hover:bg-neutral-200"
                              }`}
                          >
